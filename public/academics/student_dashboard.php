...
<div class="wrapper" style="padding: 2rem;">
            ...
            <?php foreach ($pending_verifications as $v): ?>
                <div class="card" style="border-left: 4px solid var(--accent); background: rgba(var(--accent-rgb), 0.02);">
                    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
                        ...
                        <a href="lecture_feedback.php?session_id=<?= $v['session_id'] ?>" class="btn btn-primary">Provide Feedback</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
    ...
    <div class="grid-2">
        ...
        ?>
            <a href="units.php?subject_id=<?php echo $sub['id']; ?>" class="card" style="text-decoration: none; color: inherit; border-top: 4px solid <?php echo $isElective ? 'var(--primary)' : 'transparent'; ?>;">
