    ...
    <div class="dashboard-modules" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem; margin-top: 2rem;">
        ...
        <?php if ($_SESSION['role'] === 'admin'): ?>
            ...
            <div class="card module-card" style="border: 2px solid var(--primary);">
                ...
                <a href="<?= $base_path ?>/public/academics/manage_subjects.php" class="btn btn-primary">Manage Academics</a>
            </div>
            ...
            <div class="card module-card" style="border: 2px solid var(--accent);">
                ...
                <a href="<?= $base_path ?>/public/admin/manage_permissions.php" class="btn" style="background: var(--accent); color: white;">Manage Permissions</a>
            </div>
            ...
            <div class="card module-card" style="border-top: 4px solid var(--warning);">
                ...
                <a href="<?= $base_path ?>/public/admin/elective_requests.php" class="btn btn-warning">Review Unlock Requests</a>
            </div>
            ...
            <div class="card module-card" style="border: 2px solid var(--warning);">
                ...
                <a href="<?= $base_path ?>/public/community/reviewer_dashboard.php" class="btn" style="background: var(--warning); color: var(--bg);">Review Dashboard</a>
            </div>
            ...
            <div class="card module-card" style="border-top: 4px solid var(--error);">
                ...
                <a href="<?= $base_path ?>/public/academics/admin_feedback_panel.php" class="btn btn-primary">Review Feedbacks</a>
            </div>

            <div class="card module-card">
                <h2>Semester Management</h2>
                <p>Move all students to the next semester globally and update rosters.</p>
                <form action="<?= $base_path ?>/app/actions/admin/semester_done.php" method="POST" onsubmit="return confirm('Are you sure you want to end the current semester? All students will be moved to the next semester and their class names will be updated.')">
        ...
        <?php else: ?>
            ...
            <?php if (has_permission('manage_tasks')): ?>
                ...
                <div class="card module-card">
                    ...
                    <a href="<?= $base_path ?>/public/productivity/index.php" class="btn btn-primary">Go to Tasks</a>
                </div>
            <?php endif; ?>
            ...
            <?php if (has_permission('view_student_dashboard')): ?>
                ...
                <div class="card module-card">
                    ...
                    <a href="<?= $base_path ?>/public/academics/student_dashboard.php" class="btn btn-primary">Go to Academics</a>
                </div>

                <div class="card module-card">
                    <h2>Community</h2>
                    <p>Request skill validation and build your reputation.</p>
                    <a href="<?= $base_path ?>/public/community/request.php" class="btn btn-primary">Skill Validation</a>
                </div>

                <div class="card module-card" style="border-top: 4px solid var(--warning);">
                    <h2>Anonymous Feedback Box</h2>
                    <p>Submit honest, private feedback about any faculty or subject.</p>
                    <a href="<?= $base_path ?>/public/academics/continuous_feedback.php" class="btn btn-secondary">Open Feedback Box</a>
                </div>
            <?php endif; ?>
            ...
            <?php if (has_permission('view_faculty_dashboard')): ?>
                ...
                <div class="card module-card">
                    ...
                    <a href="<?= $base_path ?>/public/academics/faculty_dashboard.php" class="btn btn-primary">Go to Academics</a>
                </div>
            <?php endif; ?>
            ...
            <?php if (has_permission('review_requests')): ?>
                ...
                <div class="card module-card">
                    ...
                    <a href="<?= $base_path ?>/public/community/reviewer_dashboard.php" class="btn btn-primary">Go to Reviews</a>
                </div>
            <?php endif; ?>
        <?php endif; ?>
