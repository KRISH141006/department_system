...
<div class="wrapper" style="padding: 2rem; margin-bottom: 4rem;">
    ...
    <div class="grid-2">
        <?php if ($is_cc): ?>
            <a href="../../../../public/academics/manage_class.php" class="card" style="text-decoration: none; color: inherit; background: var(--bg-2); border: 2px solid var(--accent); grid-column: span 2;">
        ...
        <a href="../../../../public/academics/create_subject.php" class="card" style="text-decoration: none; color: inherit;">
            <div style="font-size: 32px; margin-bottom: 12px;">📚</div>
        ...
        <a href="../../../../public/academics/create_feedback.php" class="card" style="text-decoration: none; color: inherit;">
            <div style="font-size: 32px; margin-bottom: 12px;">📝</div>
        ...
        <a href="../../../../public/academics/feedback_history.php" class="card" style="text-decoration: none; color: inherit;">
            <div style="font-size: 32px; margin-bottom: 12px;">📊</div>
        ...
        <a href="../../../../public/academics/assign_task.php" class="card" style="text-decoration: none; color: inherit; border-left: 4px solid var(--accent);">
            <div style="font-size: 32px; margin-bottom: 12px;">📋</div>
        ...
        <a href="../../../../public/academics/host_meeting.php" class="card" style="text-decoration: none; color: inherit; border-left: 4px solid #ef4444;">
            <div style="font-size: 32px; margin-bottom: 12px;">🎥</div>
        ...
        <a href="../../../../public/academics/submissions.php" class="card" style="text-decoration: none; color: inherit; border-left: 4px solid #22c55e;">
            <div style="font-size: 32px; margin-bottom: 12px;">📤</div>
        ...
        <a href="../../../../public/academics/assigned_tasks_history.php" class="card" style="text-decoration: none; color: inherit; border-left: 4px solid var(--primary);">
            <div style="font-size: 32px; margin-bottom: 12px;">📜</div>
        ...
        <a href="../../../../public/academics/syllabus_verification.php" class="card" style="text-decoration: none; color: inherit; border-top: 4px solid var(--success);">
            <?php 
    ...
    <div style="margin-top: 60px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
            ...
            <a href="../../../../public/academics/create_subject.php" class="btn btn-sm" style="background: var(--accent); color: white;">+ Add Subject</a>
        </div>
                            ...
                            <td style="padding: 1.25rem; text-align: right;">
                                <div style="display: flex; flex-direction: column; gap: 6px; align-items: flex-end;">
                                    <div style="display: flex; gap: 8px; justify-content: flex-end;">
                                        <?php if ($isElective): ?>
                                            <a href="../../../../public/academics/manage_elective_students.php?id=<?php echo $sub['subject_id']; ?>" class="btn btn-sm btn-secondary" title="Manage Students">Students</a>
                                        <?php endif; ?>
                                        <a href="../../../../public/academics/units.php?subject_id=<?php echo $sub['subject_id']; ?>&class_id=<?php echo $class_ids[0]; ?>" class="btn btn-sm btn-secondary" title="Syllabus/Topics">Units</a>
                                        <a href="../../../../public/academics/create_subject.php?id=<?php echo $sub['subject_id']; ?>" class="btn btn-sm btn-secondary" title="Edit Subject">
                                    ...
                                    <div style="display: flex; flex-wrap: wrap; gap: 4px; justify-content: flex-end; max-width: 250px;">
                                        <?php foreach ($class_subject_ids as $index => $csid): ?>
                                            <a href="../../../../public/academics/select_student.php?class_id=<?php echo $csid; ?>" class="btn btn-sm <?= $hasAssignments ? 'btn-secondary' : 'btn-primary'; ?>" style="font-size: 10px; padding: 2px 6px;">
