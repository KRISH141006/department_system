...
<div class="wrapper" style="padding: 2rem;">
    <div style="max-width: 800px; margin: 0 auto;">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 2rem;">
            ...
            <a href="../../../../public/academics/submissions.php?assignment_id=<?= $submission['assignment_id'] ?>" class="btn btn-secondary">Back to List</a>
        </div>
                    ...
                    <?php if ($submission['submission_path']): ?>
                        <div style="background: var(--bg-2); padding: 1.5rem; border-radius: 8px; border: 1px solid var(--border);">
                            <div style="display: flex; align-items: center; gap: 15px;">
                                ...
                                <a href="../../../../public/<?= htmlspecialchars($submission['submission_path']) ?>" class="btn btn-sm btn-primary" target="_blank">Download File</a>
                            </div>
                        </div>
                    <?php else: ?>
