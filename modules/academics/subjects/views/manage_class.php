                            ...
                            <?php foreach ($students as $s): ?>
                                <tr style="border-bottom: 1px solid var(--border);">
                                    ...
                                    <td style="padding: 10px; text-align: right;">
                                        <a href="../../../../public/academics/student_progress.php?student_id=<?= $s['id'] ?>" class="btn btn-sm" style="background: var(--accent); color: white; border: none; text-decoration: none;">View Progress</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
