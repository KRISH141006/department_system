...
<div class="wrapper" style="padding: 2rem;">
    ...
    <?php if (empty($existing_forms)): ?>
        <div class="card" style="text-align: center; color: var(--text-3); padding: 5rem;">
            ...
            <a href="../../../../public/academics/create_feedback.php" class="btn btn-primary" style="margin-top: 1.5rem;">Create Feedback Form</a>
        </div>
    <?php else: ?>
                    ...
                    <?php foreach ($existing_forms as $f): ?>
                        <tr style="border-bottom: 1px solid var(--border);">
                            ...
                            <td style="padding: 1.25rem; text-align: right;">
                                <a href="../../../../public/academics/feedback_results.php?form_id=<?= $f['id'] ?>" class="btn btn-sm btn-primary">View Results</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
